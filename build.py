...
hero = f'''<section class="brand-hero"><div class="hero-copy"><div class="eyebrow">{e(profile['role'])}</div><h1>让 AI 走出实验，<br><span>进入真实业务。</span></h1><p>{e(profile['intro'])}</p><div class="hero-actions"><a class="primary-link" href="#projects">探索我的项目 <span>↗</span></a><a class="text-link" href="./ask.html">向我的 Agent 提问 →</a></div></div><aside class="identity-card"><div class="identity-monogram">Bing</div><h2 class="identity-contact"><span>{e(profile['name'])} ｜</span> <a href="mailto:bingbai.me@gmail.com">bingbai.me@gmail.com</a></h2><p>AI SOLUTIONS & ENGINEERING</p><a href="./about.html">认识我 <span>↗</span></a></aside></section>'''
