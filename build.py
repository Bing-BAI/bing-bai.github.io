...
for p in profile['projects']:
    ...
    content = f'<div class="reading"><a class="back" href="../archive.html#projects">← 返回项目经历</a><header class="article-head"><div class="eyebrow">{e(p["domain"])}</div><h1>{e(p["title"])}</h1><p>{e(p["role"])}</p></header>{outline}<article class="prose case-study">{body}</article><div class="article-end">客户信息已匿名化 · 仅展示个人参与范围</div><a class="back" href="../ask.html">向 AI 助手了解更多 →</a></div>'
