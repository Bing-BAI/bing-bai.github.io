...
I contributed to backend and data migration work, workflow fixes, and video preprocessing, configuration and validation for the logistics client. When variable frame rates caused analysis results to drift from the playback timeline, I used FFmpeg to standardize frame rates and checked alignment against the video.
